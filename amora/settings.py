"""
Django settings for amora project.
...
SECRET_KEY = 'django-insecure-1%8suea1)jx+^%47px(4m7)0m3^!j3p#q7%=+l8)x!-h$4u#d4'
...
# Defina o backend de e-mail para o EmailMessage
